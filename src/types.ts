...
export type StageMode = 'library' | 'editor' | 'import' | 'setlist' | 'perform' | 'stage' | 'displays' | 'pedals' | 'settings' | 'admin' | 'diagnostics' | 'help';
...
export type PerformanceState = {
  ...
  showArtistInChartByProfile: Partial<Record<DeviceProfile, boolean>>;
